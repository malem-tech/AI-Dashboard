...
export default function SimpleModal() {
  ...
  const body = (
    <div   id="cross" style={{height: "94%",backgroundColor:"rgba(27,31,56,1)",borderLeft: "1px solid orange",borderTop: "1px solid orange", width:"300px", zIndex:5,position:"absolute",right:"0px",bottom:"0px",overflow:"hidden"}} autoid = "professor-close-button"> 
    ...
    <div id="chat" style={{display:"flex",flexDirection:"column",width:"95%",height:"75%", padding:"8px", position:"relative", overflowY:"auto", overflowX:"hidden"}} autoid ="human" autoid ="ai">
 ...
 }} placeholder="Type here..." autoid = "professor-input-box"> 
 </input>
 <img onClick={componentDidMount} src={Send} alt="Send" style={{width: "10%", position:"absolute", right:"8px", bottom:"30px", cursor:"pointer"}} autoid = "professor-send-button"></img>
  ...
  return (
    ...
    autoid = "professor-button">
        <img onClick={handleOpen} src={Image} alt="Freda" style={{width: "50%", marginTop: "-.5rem",marginRight:"-3rem", cursor:"pointer"}}></img>
      <Modal
        open={open}
        hideBackdrop={true}
